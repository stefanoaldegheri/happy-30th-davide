...
const expectedFinalFen = '7r/8/4R3/3P2P1/3N1k2/q3p1BP/1p5P/6K1 b - - 6 6';
...
console.log('Expected final position FEN:', expectedFinalFen);
console.log('Match:', game.fen() === expectedFinalFen);